"""
Service to improve course content using DeepSeek API
...
# Initialize DeepSeek client with API key from Django settings
...
Retourne SEULEMENT le JSON, sans texte supplémentaire."""
    ...
    try:
        ...
        print(f"DeepSeek error generating quizzes: {e}")
        return []
